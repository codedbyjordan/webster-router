...
export declare const isAsync: (fn: Function) => true | RegExpMatchArray | null;
export declare const composeHandler: ({ path, method, hooks, validator, handler, handleError, definitions, schema, onRequest, config, getReporter }: {
    path: string;
    method: string;
...
export declare const composeGeneralHandler: (app: Elysia<any, any, any, any, any>) => any;
export declare const composeErrorHandler: (app: Elysia<any, any, any, any, any>) => any;
