...
export type Context<Route extends RouteSchema = RouteSchema, Decorators extends DecoratorBase = {
    ...
    body: Route['body'];
    query: undefined extends Route['query'] ? Record<string, string | null> : Route['query'];
...
export type PreContext<Route extends RouteSchema = RouteSchema, Decorators extends DecoratorBase = {
    request: {};
    store: {};
}> = Prettify<{
    headers: undefined extends Route['headers'] ? Record<string, string | null> : Route['headers'];
