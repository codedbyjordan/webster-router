...
exports.ElysiaType = {
    ...
    Files: (options = {}) => typebox_1.Type.Transform(Files(options))
        .Decode((value) => {
        if (Array.isArray(value))
            return value;
        return [value];
...
__exportStar(require("@sinclair/typebox/system"), exports);
__exportStar(require("@sinclair/typebox/compiler"), exports);
// type Template =
// 	| string
// 	| number
// 	| bigint
